...
- [pnpm docs: Referencing workspace packages through aliases](https://pnpm.io/workspaces#referencing-workspace-packages-through-aliases)
...
- [pnpm docs: link-workspace-packages](https://pnpm.io/npmrc#workspace-settings)
- [Using pnpm workspaces in 2023?](https://answers.netlify.com/t/using-pnpm-workspaces-in-2023/84882)
...
- [javascript yyyy-mm-dd hh:mm:ss to date](https://normal-gom-jelly.tistory.com/entry/javascript-yyyy-mm-dd-hhmmss-to-date)
- [github: pnpm-workspace-example](https://github.com/ashleydavis/pnpm-workspace-examples/tree/main/typescript/packages/validation)
- [TypeScript 시작하기](https://civilizeddev.github.io/blog/typescript-getting-started/)
- [fetch 요청을 취소하는 방법(Promise.race 아님! AbortController, signal)](https://youtube.com/shorts/nMpQ9uU_cog?si=jiaJ5sgI1obVTh9b)
- [매개변수가 많을 때 좋은 RORO 패턴(자바스크립트, feat. inlay hints)](https://youtube.com/shorts/xirRddcqbrU?si=IuLXKScZSkuNFm0Y)
- [TypeScript satisfies 연산자는 언제 쓸까? (타입추론, 타입검사의 장점을 동시에)](https://youtube.com/shorts/aFrDim6sQa0?si=Kbf8SoKF0cY7-LmH)
