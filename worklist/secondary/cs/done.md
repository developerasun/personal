...
- [wikipedia: 데드맨 스위치](https://ko.wikipedia.org/wiki/%EB%8D%B0%EB%93%9C%EB%A7%A8_%EC%8A%A4%EC%9C%84%EC%B9%98)
- [[Linux] 쉘 스크립트(Shell script) 5편 - 트랩(trap) 사용하기, 에러 옵션(set -e, set -o)](https://hi-ai0913.tistory.com/14)
- []()
- []()
- []()
- []()
